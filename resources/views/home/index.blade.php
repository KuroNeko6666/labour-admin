                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <a class='text-dark' href="{{ route('company') . '?member=silver' }}"><small>klik untuk
                                        detail</small></a>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <a class='text-dark' href="{{ route('company') . '?member=gold' }}"><small>klik untuk
                                        detail</small></a>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-comments fa-2x text-gray-300"></i>
            ...
            <div class="col-xl-12 col-lg-12 col">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Registrasi Pengguna</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
