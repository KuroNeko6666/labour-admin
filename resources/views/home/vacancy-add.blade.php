    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Formulir Tambah Lowongan</h6>
            </div>
            <div class="card-body">
                ...
                <form action="{{ $path }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="jobdesk" type="text" class="form-control @error('jobdesk') is-invalid @enderror" id="jobdesk"></textarea>
                            @error('jobdesk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
